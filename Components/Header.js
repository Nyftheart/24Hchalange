...
import Logo from "../public/Icone_Event_earth.png"
import {
    BellIcon,
    ChatIcon,
    ChevronDownIcon,
    ...
    return(
        ...
        <div className="flex items-center">
            ...
            <div className="flex ml-2 items-center rounded-full bg-gray-100 p-2">
                ...
                <input className="hidden md:inline-flex ml-2 items-center bg-transparent outline-none placeholder-gray-500 flex-shrink" type="text" placeholder="Search Event" />
            </div>
            ...
            <div className="flex items-center sm:space-x-2 justify-end">
                <p className="whitespace-nowrap font-semibold pr-3">Nyftheart</p>
